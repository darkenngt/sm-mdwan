...
@Component({
    ...
    export class ListOrders implements OnInit, AfterViewInit{
        ...
        public showPickup: boolean = true;
        public showEmergencia: boolean = true;
        public showProgramada: boolean = true;
        ...
        WebSocketDelivery(): void {
            if (!this.firstCall){
                ...
                this.subscriptionProgramer = interval(15000)
                .subscribe(x =>{
                    this.getprogramadas()
                    //console.log(this.delOrdersStructure+"1")
                    //console.log(this.firstCall)
        ...
        ngOnDestroy(): void {
            ...
            this.subscriptionProgramer.unsubscribe();
          }
